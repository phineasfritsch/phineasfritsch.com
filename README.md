...
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `npm run gate`      | Everything, numbered, and **every gate prints a count** — checked: three of them printed `—` for weeks because their regexes matched output their tools do not produce. Green and red are not enough. A count that falls below its floor in `ops/floors.json` fails the run, and the floor only ever ratchets up, on a fully green run. |
